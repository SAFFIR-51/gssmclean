...
export const DIALYSIS_PROMISE: PromiseCard[] = [
  ...
  { num: "04", title: "이른 아침·야간 투석", desc: "월·수·금 오전 7시부터 오후 11시까지 운영하여, 직장인 환자분도 일상을 유지하며 치료받으실 수 있습니다.", img: img(6) },
];
...
export const INTERNAL: Condition[] = [
  ...
  {
    key: "dyslipidemia", label: "이상지질혈증", title: "이상지질혈증 클리닉", img: img(23),
  ...
  {
    key: "thyroid", label: "갑상선질환", title: "갑상선 클리닉", img: img(30),
