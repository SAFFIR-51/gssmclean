...
export const DIALYSIS_PROMISE: PromiseCard[] = [
  ...
  { num: "04", title: "최신 투석장비를 이용한 고효율 혈액투석", desc: "NIPRO NCU-18 장비를 이용하여 고효율 혈액투석여과(online HDF)를 시행합니다. 투석 상태를 실시간으로 확인하며 보다 정확하고 안정적인 치료를 제공합니다. 모든 환자에게 동일한 투석을 시행하지 않습니다. 환자의 혈관 상태, 영양 상태 및 동반 질환을 고려하여 다양한 종류의 투석막을 선택함으로써 보다 효율적이고 편안한 투석치료를 제공합니다.", img: "/images/promise-equipment.jpg" },
