...
export const DIALYSIS_PROMISE: PromiseCard[] = [
  ...
  { num: "02", title: "30년 이상의 투석실 경험을 갖춘 전문 간호사", desc: "30년 이상 혈액투석실에서 근무한 전문간호사가 상주하여 환자 상태를 세심하게 관찰합니다. 투석 중 발생할 수 있는 다양한 상황에 신속하게 대응하며, 환자분들이 안심하고 치료받으실 수 있는 환경을 제공합니다.", img: img(17) },
  { num: "03", title: "철저한 정수 시스템과 안전한 투석 환경", desc: "혈액투석의 핵심은 깨끗한 물입니다. 본원은 철저한 정수 관리 시스템을 구축하여 투석액의 수질을 지속적으로 관리하며, 환자분들이 안심하고 치료받을 수 있는 안전한 환경을 제공합니다.", img: img(13) },
  { num: "04", title: "최신 투석장비를 이용한 고효율 혈액투석", desc: "NIPRO NCU-18 장비를 이용하여 고효율 혈액투석여과(online HDF)를 시행합니다. 투석 상태를 실시간으로 확인하며 보다 정확하고 안정적인 치료를 제공합니다. 모든 환자에게 동일한 투석을 시행하지 않습니다. 환자의 혈관 상태, 영양 상태 및 동반 질환을 고려하여 다양한 종류의 투석막을 선택함으로써 보다 효율적이고 편안한 투석치료를 제공합니다.", img: img(9) },
  { num: "05", title: "직장인을 위한 야간 투석", desc: "이른 아침부터 야간까지 운영하여 직장인도 치료와 일상을 함께 이어갈 수 있습니다. 본원은 오전 7시부터 오후 11시까지 운영하여, 출근 전 아침 투석과 퇴근 후 야간 투석이 가능합니다. 직장·학업·일상생활로 낮 시간 투석이 어려운 환자분들도 자신의 생활 패턴에 맞추어 편리하게 치료받으실 수 있습니다.", img: img(6) },
];
